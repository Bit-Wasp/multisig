...
class Verify_Signature {
	...
	public static $secp256k1 = SECcurve::curve_secp256k1();
	public static $secp256k1_G = SECcurve::generator_secp256k1();

	public static function isMessageSignatureValid($address, $signature, $message) {
	...
	public static function gmp2bin($v) {
		$binStr = '';
